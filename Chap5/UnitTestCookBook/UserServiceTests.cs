...
using Apress.UnitTestCookbook.SampleApp.Services;
using AutoFixture;
...
public class UserServiceTests
{
    ...
    [Fact]
    public async Task GetByIdAsync_WhenIdIsGreaterThanZeroAndUserRepositoryReturnsNull_ShouldReturnNull()
    {
        // Arrange
        var id = _fixture.Create<int>();
    ...
    [Fact]
    public async Task GetByIdAsync_WhenAListOfUserIdIsProvidedAndSomeAreNotDeleted_ShouldReturnFalseAndInvokeDeleteByIdAsyncForEachUserId()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetByIdAsync_WhenAListOfUserIdIsProvidedAndAllAreDeleted_ShouldReturnTrueAndInvokeDeleteByIdAsyncForEachUserId()
    {
        // Arrange
        var ids = _fixture.CreateMany<int>(2);
        var firstId = ids.First();
        ...
        _userRepositoryMock.DeleteByIdAsync(Arg.Is(firstId)).Returns(1);
        _userRepositoryMock.DeleteByIdAsync(Arg.Is(lastId)).Returns(1);
